            ...
            <React.Fragment>
                <div id="skills" className="skills_container">
                    ...
                    <div className="grid-container">
                        ...
                        <div className="lg-info">
                            <img className="skills-imgpart" src="https://www.w3schools.com/whatis/img_css.jpg" />
                            <h2>CSS</h2>
