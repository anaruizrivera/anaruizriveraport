                ...
                <main>
                    ...
                    <section className="grid">
                        <div className="separatediv">
                            ...
                            <button className="links-button" href="https://github.com/anaruizrivera/Gateway-Project">GitHub</button>
                            <button className="links-button" href="https://anaruiz-gateway-project.netlify.app/">Website</button>
                        </div>
                        ...
                        <button className="links-button" href="https://github.com/anaruizrivera/Hotel-App">GitHub</button>
                        <button className="links-button" href="anaruiz-hotel-app.netlify.app">Website</button>
                        </div>
                        ...
                        <button className="links-button" href="https://github.com/anaruizrivera/Speech-Recognition-Guessing-Game-API">GitHub</button>
                        <button className="links-button" href="https://anaruiz-guessing-game.netlify.app/">Website</button>
                        </div>
                        ...
                        <button className="links-button" href="https://github.com/anaruizrivera/Animated-Navigation-Bar">GitHub</button>
                        <button className="links-button" href="https://anaruiz-navbar.netlify.app/">Website</button>
                        </div>
                        ...
                        <button className="links-button" href="https://github.com/anaruizrivera/github-cards">GitHub</button>
                        <button className="links-button" href="https://anaruiz.netlify.app/">Website</button>
                        </div>
                        ...
                        <button className="links-button" href="https://github.com/anaruizrivera/tic-tac-toe-game-app">GitHub</button>
                        <button className="links-button" href="https://anaruizrivera-tic-tac-toe-game.netlify.app/">Website</button>
                        </div>
                        ...
                        <button className="links-button" href="https://github.com/anaruizrivera/Friend-App-List">GitHub</button>
                        <button className="links-button" href="https://anaruizrivera-friend-list.netlify.app/">Website</button>
                        </div>
                        ...
                        <button className="links-button" href="https://github.com/anaruizrivera/E-commerce-React">GitHub</button>
                        <button className="links-button" href="https://anaruizrivera-e-commerce-project.netlify.app/">Website</button>
                        </div>
                        ...
                        <button className="links-button" href="https://github.com/anaruizrivera/counterAppp">GitHub</button>
                        <button className="links-button" href="https://anaruizcounterapp.netlify.app/">Website</button>
                        </div>
                        ...
                        <p className="text">This website was base on Re-designing wikipedia and making improvement on the website. This was a group project, were I was able to colaborate and integrate parts of codes.</p>
                        <button className="links-button" href="https://github.com/Veronica-B/wikipedia">GitHub</button>
